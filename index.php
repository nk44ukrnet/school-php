        ...
        <section class="hero">
            <div class="hero__wrapper">
                <div class="hero__container">
                    ...
                    <p class="desc">
                        Inventor School – чартерна школа, яка  знаходиться поруч з вашою домівкою. Це зручна, безпечна і сучасна форма навчання. Діти навчаються за освітніми програмами НУШ з додаванням STEM-підходу. Професійна команда вчителів робить все для ефективного розвитку дітей і створює доброзичливу атмосферу навчання.
                    </p>
                </div>
            </div>
        </section>
