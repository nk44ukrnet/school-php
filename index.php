            ...
            <div class="content_size">
                <div class="packages__holder">
                    <div class="packages__item">
                        ...
                        <div class="packages__cell">Можливість підключатися до онлан-навчання в разі відсутності в
                            школі
                        </div>
                        <div class="packages__cell">За програмою Нової української школи (НУЩ) та відповідними
                            найкращими підручниками, які ми підібрали у відповідності до STEM-підходу
                        </div>
                        <div class="packages__cell">Поглиблене вивчення математики за сінгапурською програмою та з
                            білінгвальним навчанням
                        </div>
    ...
    <div class="modal modal__backdrop" id="modalPrograms">
        <div class="modal__container">
            ...
            <div class="modal__body">
                ...
                <br>
                <p>
                    Відповідають Державному стандарту та є авторськими розробками колективу Inventor school та
                    методичного
                    відділу STEM-школи
                    INVENTOR з математики та логіки, української мови та літератури, курсу
                    "Я досліджую світ", музики, образотворчого мистецтва, фізичної культури,
                    основ механіки, робототехніки, архітектури, інформатики, основ природничих
                    наук.
                </p>
            </div>
        </div>
