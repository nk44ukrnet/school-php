...
<div class="modal modal__backdrop" id="modalProgram3">
    <div class="modal__container">
        ...
        <div class="modal__body">
            ...
            <strong>Що вивчаємо:</strong>
            <br><br>
            Практичний курс, що інтегрує в собі природничу, здоров’язбережувальну, соціально-громадянську,
            культурно-історичну, технологічну та інформатичну складові. Кожен тематичний модуль закінчується публічним
            захистом проектної роботи із різних сфер життя людини, планети, Всесвіту.
            <br><br>
            <strong>Яких результатів досягаємо:</strong>
            <br><br>
